...
async function triggerRender() {
  ...
  try {
    ...
    renderResults.value = [{ label: 'Error', variantId: null, imageUrl: null, error: 'Failed to load vehicle image', loading: false, elapsed: null }]
  ...
  if (selectedVariantId.value) {
    ...
    const result: RenderResult = { label, variantId: selectedVariantId.value, imageUrl: null, error: null, loading: true, elapsed: null }
  ...
  <div class="rp">
    ...
    <div v-if="!isAuthenticated" class="rp-login">
      <div class="rp-login-card">
        <div class="rp-login-header">User Playground</div>
